...
from data import get_training_dataloader
...
def load_dataset(args):
    dataloader = get_training_dataloader(
        cifar_10_dir=os.path.join(os.environ["HAWQ_JET_TAGGING"], "data/cifar10"),
...
def main(args):
    ...
    plt.grid()
    plt.savefig(os.environ["HAWQ_JET_TAGGING"]+'/results/hessian/rn08_trace.png')
    plt.yscale('log')
    plt.savefig(os.environ["HAWQ_JET_TAGGING"]+'/results/hessian/rn08_trace-log.png')
    plt.close()
...
# python hessian.py --resume /data/jcampos/hawq-jet-tagging/checkpoints/ic/11.13.2023-3.40.4/resnet_best.ckpt
